...
**Day 33:** Spring Boot with JDBC & MySQL (JdbcTemplate, REST APIs)  
**Day 34:** Spring Boot CRUD REST API (GET, POST, PUT, DELETE) with global exception handling  
**Day 35:** Spring Boot + JPA + Hibernate (ORM mapping, Entity, Repository, CRUD REST APIs)  
...
**Day 39:** Search & Filter APIs (custom queries, keyword search, conditional fetching)  
